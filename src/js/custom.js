...
window.onload = function(){
	...
	for (var i=0;i<tabs.length;i++){
		tabs[i].addEventListener("click", function (){
			...
			console.log(this.getAttribute("container"));
...
function chartFrame (language, format) {
...
/*
 ...
 var projectChart1 = anychart.ganttProject();
 projectChart1.container('container-dashboard');
