...
window.onload = function(){
	...
	getFormatters("en-us").forEach(function(formatter){
		formatsHolder.appendChild(
			createListItem(
				"<a>"+formatter+"</a>",
				function(){
					chartFrame("en-us", formatter, "//cdn.anychart.com/locale/1.0.0/english-(united-states).js");
					textField.value = "";
				}
			)
		);
	...
	chartFrame ("en-us", anychart.format.locales["en-us"].dateTimeLocale.timeFormats[0], "//cdn.anychart.com/locale/1.0.0/english-(united-states).js");
